...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { s_name: @subject.s_name, teacher_id: @subject.teacher_id } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { s_name: @subject.s_name, teacher_id: @subject.teacher_id } }
