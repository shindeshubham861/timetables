...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { division: @division.division, quantiy: @division.quantiy, standard_id: @division.standard_id } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { division: @division.division, quantiy: @division.quantiy, standard_id: @division.standard_id } }
