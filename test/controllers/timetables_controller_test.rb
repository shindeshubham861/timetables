...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { division: @timetable.division, lecture: @timetable.lecture, standard: @timetable.standard, subject_id: @timetable.subject_id, teacher_id: @timetable.teacher_id } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { division: @timetable.division, lecture: @timetable.lecture, standard: @timetable.standard, subject_id: @timetable.subject_id, teacher_id: @timetable.teacher_id } }
